...
/**
 * @brief Splits a string into words using specified delimiters (repeated delimiters are ignored).
 *
...
/**
 * @brief Splits a string into words using a specified single delimiter character.
 *
 * @param str The input string to be split.
