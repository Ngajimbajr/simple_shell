...
int printChar(char );
int printCharToFileDescriptor(char , int );
int printStringToFileDescriptor(char *, int );
 /* string.c */
...
/* environment_function.c */
int printCurrentEnvironment(info_t *);
char *getEnvironmentVariable(info_t *, const char *);
int setOrModifyEnvironmentVariable(info_t *);
